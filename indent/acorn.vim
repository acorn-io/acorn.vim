" Vim indent file
" Language:		Acorn (copy of Vim-distributed JSON indent file)
"
" We include copy a copy of the Vim license in this directory, and leave the
" header of the original JSON indent file intact in the remainder of this
" comment.
"
